...
(function oneko() {
  ...
  let nekoPosX = rect.left + rect.width / 2 - 130;
  let nekoPosY = rect.top + rect.height / 2 - 16;
  ...
  function init() {
    ...
    let nekoFile = "/scripts/oneko.gif";
    ...
    nekoEl.addEventListener("contextmenu", removeCat);
